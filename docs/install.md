...
# skip it and alerts log a warning and do nothing until you create the file
# on the running host later (same command minus /mnt; no rebuild needed,
# test with: sudo systemctl start alert-boot)
